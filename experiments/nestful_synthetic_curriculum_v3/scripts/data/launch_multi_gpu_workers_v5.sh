...
AGENTIC_ACCEPTANCE_POLICY_VAL="${AGENTIC_ACCEPTANCE_POLICY:-rollout_primary}"
AGENTIC_GEN_MODE_VAL="${AGENTIC_GEN_MODE:-registry_first}"
...
echo "[launch-v5] acceptance     = $AGENTIC_ACCEPTANCE_POLICY_VAL gen_mode=$AGENTIC_GEN_MODE_VAL"
...
export AGENTIC_ACCEPTANCE_POLICY="$AGENTIC_ACCEPTANCE_POLICY_VAL" && \
export AGENTIC_GEN_MODE="$AGENTIC_GEN_MODE_VAL" && \
