...
ROLLOUT_REQUIRE_ACHIEVABLE_WIN_VAL="${ROLLOUT_REQUIRE_ACHIEVABLE_WIN:-1}"
...
LOCAL_WEAK_4BIT_VAL="${LOCAL_WEAK_4BIT:-1}"
...
echo "[launch] weak_solver    = $WEAK_SOLVER_BACKEND_VAL $LOCAL_WEAK_MODEL_VAL (4bit=$LOCAL_WEAK_4BIT_VAL)"
echo "[launch] early-stop     = MIN_ACCEPT_RATE=$MIN_ACCEPT_RATE_VAL (0=disabled)"
echo "======================================================================="
