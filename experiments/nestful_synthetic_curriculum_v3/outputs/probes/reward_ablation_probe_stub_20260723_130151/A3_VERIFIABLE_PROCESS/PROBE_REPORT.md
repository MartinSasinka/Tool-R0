# PROBE REPORT — A3_VERIFIABLE_PROCESS
...
Reward: `reward_ablation_A3_VERIFIABLE_PROCESS` | checkpoint: `base model` | executor.mode: `synthetic`
...
| mean unique rewards / group | 4.0 |
| reward entropy (bits) | 2.3424 |
| distinct reward values | 6 |
